...
load("C:\\Users\\Max_H\\OneDrive - University of Guelph\\Pedagogy\\PGDA\\AMOVA\\amova_se.RData")
...
ylim <- c(0, 1)
## plotting
png("C:\\Users\\Max_H\\OneDrive - University of Guelph\\Pedagogy\\PGDA\\Figures\\loci\\amova\\phi_season.png", 
...
title("AMOVA Phi Statistic By Locus Between Seasons", outer = T, cex.main = 1.5)
dev.off()