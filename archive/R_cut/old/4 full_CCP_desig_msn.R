...
## plotting it
png("Results\\msn\\full_msn_ccp.png",
    family="Times New Roman", width = 6, height = 6, pointsize = 10, units = "in", res = 500)
par(oma = c(1, 1, 1, 1), mar = c(0, 0, 0, 0))
plot(msn, col = coloursIcl[bests], ylab = "", xlab = "", xaxt = "n", yaxt = "n", cex = 0.4, font = 2, type = "t", ord = conf)
legends("bottomright", bests, coloursDend, "ICL Groups", cex = 0.75)
